...
favClick(someId,currentFavStatus){
  //clone state (we'll call this newlist)
...
//    this.helperClassName = this.props.info.name;
    ...
    return (
      <div className={this.helperClassName + ' activeContact'}>
        <div className='activeHeader'>
          <div className='contactButton' onClick={()=>{this.props.modalExit()}}><i className="fa fa-angle-left" aria-hidden="true"></i>Contacts</div>
          {this.props.info.isFavorite===true? <button className="starstar" onClick={()=>{this.props.handleClick(someId, currentFavStatus)}}> &#9733; </button>:<button className="starstar" onClick={()=>{this.props.handleClick(someId, currentFavStatus)}}> &#9734; </button>}
        </div>
        <img src={this.props.info.largeImageURL}/>
        <h3>{this.props.info.name!==""?this.props.info.name: "help"}</h3>
        <h5>{this.props.info.companyName}</h5>
        {this.props.info.phone.home!==""&&this.props.info.phone.home!==undefined? <div className="category"> <h6>Phone: </h6> <p>{this.props.info.phone.home}</p> <div className="phoneType"> Home </div></div>:<h5 className="noShow">Not Provided</h5>}
        {this.props.info.phone.mobile!==""&&this.props.info.phone.mobile!==undefined? <div className="category"> <h6>Phone: </h6> <p>{this.props.info.phone.mobile}</p> <div className="phoneType"> Mobile </div></div>:<h5 className="noShow">Not Provided</h5>}
        {this.props.info.phone.work!==""&&this.props.info.phone.work!==undefined? <div className="category"> <h6>Phone: </h6> <p>{this.props.info.phone.work}</p> <div className="phoneType"> Work </div></div>:<h5 className="noShow">Not Provided</h5>}
